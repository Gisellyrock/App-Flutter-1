...
class MyProducts {
  static List<Product> allProducts = [
    ...MyProducts.gamerList,
    ...MyProducts.hardwareList,
    ...MyProducts.networkList,
  ];
  static List<Product> gamerList = [
    Product(
      id: 1,
  ...
  static List<Product> hardwareList = [
    Product(
      id: 1,
  ...
  static List<Product> networkList = [
    Product(
      id: 1,
